...
1从综合评分较高和属于近期最强主线板块的个股中，优先选择
2行业景气度高或周期反转向好,个股业绩增长确定性高,属于行业龙头或细分领域领先者，毛利高、技术强、现金流表现良好
3近三个月内无定增预案、无减持公告、未来半年无解禁压力、机构持股比例高且稳定、无重大诉讼风险、无重大财务风险
4属于机构重点关注的个股，未来上涨空间大(给出合理的上涨空间预估)
5剔除涨幅已巨大的个股(如短期翻倍的）,除非业绩和技术面极其强势且未来空间仍大,趋势和综合评分靠前的个股可以适当放宽这个条件
...
3、个股分析:输出分析后筛选出的股票列表，要求理由清晰且有数据支撑，并给出未来上涨空间预估和技术面分析结论
4、附上评分最高的10只股票的综合评分和趋势强度数据，给读者参考
"""
