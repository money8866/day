...
日期：20260904
股票池：1426只 | HVT事件：209只 | 今日新增：16只
引擎：V3.0 双评分（启用） | 校准表：已加载 | FE增强层：已计算209只

状态分布：DISTRIBUTION=62，HVT_STRONG=60，FAILED=43，LOCKED=15，BREAKOUT_READY=12，T20_ROCKET_WATCH=11，EXIT=4，PRIMARY_BUY=1，WATCH=1
...
| 5 | 603150.SH | 万朗磁塑 | 78 | 14 | T20_ROCKET_WATCH | 收盘位置 | 扩张空间18，供给吸收7 |
| 6 | 688536.SH | 思瑞浦 | 78 | 14 | T20_ROCKET_WATCH | 收盘位置 | 扩张空间20，供给吸收14 |
| 7 | 002354.SZ | 天娱数科 | 78 | 14 | T20_ROCKET_WATCH | 收盘位置 | 扩张空间18，供给吸收7 |
| 8 | 002868.SZ | 绿康生化 | 77 | 14 | T20_ROCKET_WATCH | 收盘位置 | 扩张空间20，供给吸收7 |
| 9 | 600150.SH | 中国船舶 | 76 | 14 | T20_ROCKET_WATCH | 收盘位置 | 扩张空间13，供给吸收7 |
| 10 | 600519.SH | 贵州茅台 | 75 | 14 | T20_ROCKET_WATCH | 收盘位置 | 扩张空间14，供给吸收15 |
| 11 | 002299.SZ | 圣农发展 | 75 | 14 | T20_ROCKET_WATCH | 收盘位置 | 扩张空间13，供给吸收7 |
...
| 000628.SZ | 高新发展 | NEAR | 20260901 | 49.36 | 20260902 | 1.64 | +1.8% | +7.2% |
...
| 603270.SH | 金帝股份 | HVT_STRONG | 77 | 0 | 76 | 91 | 97 | 82 | 67 | DEVELOPING | 50% | 90 | 10 | RE_ACCELERATION |
...
| 301122.SZ | 采纳股份 | HVT_STRONG | 72 | 0 | 64 | 90 | 99 | 71 | 69 | DEVELOPING | 97% | 75 | 45 | RE_ACCELERATION |
...
| 603565.SH | 中谷物流 | NEW_TREND | 64.2 | 50.9 | T60 | WAIT | 13.66 | 13.52~13.90 | 12.37 | 14.24 | - |
...
| 605365.SH | 立达信 | NEW_TREND | 58.5 | 56.0 | T60 | WAIT | 16.34 | 16.18~16.69 | 14.95 | 17.18 | - |
...
| 300990.SZ | 同飞股份 | RE_ACCELERATION | 70.8 | 64.7 | T20 | NO_CHASE | 85.09 | 84.24~87.90 | 71.29 | 91.82 | - |
...
| 600354.SH | 敦煌种业 | RE_ACCELERATION | 70.3 | 61.0 | T20 | NO_CHASE | 7.06 | 6.99~7.21 | 6.32 | 7.42 | - |
...
| 300985.SZ | 致远新能 | DISTRIBUTION | 49.2 | 结构状态DISTRIBUTION（硬风控覆盖）；硬否决：结构状态:DISTRIBUTION |
| 600784.SH | 鲁银投资 | DISTRIBUTION | 49.7 | 结构状态DISTRIBUTION（硬风控覆盖）；硬否决：结构状态:DISTRIBUTION |
...
★ WAIT（88只，需继续确认）：世纪华通、吉比特、航宇科技、中国人保、宁波银行、安琪酵母
...
- **中谷物流（603565.SH）** FE=54 ExtRisk=10 → 尚未完成平台突破（HVT天量日20260824后锁筹观察中）；等待放量突破 13.66（量≥1.3x、收盘位≥0.75）后才允许买入
...
- **五洲医疗（301234.SZ）** FE=53 ExtRisk=43 → 收盘107.00已超追高上限93.88（突破位+1.2×ATR）；FE20=98 再高也不改变追涨的风险收益比（§18）
...
★ 高FE但不追：海天精工、华天酒店、高新发展
★ 明日不买：金螳螂、神奇制药、亿联网络、致远新能、鲁银投资
★ 如果全部没有确认：NO TRADE

核心原则：只执行“未来扩张 + 当前执行条件”同时成立的股票；没有确认就不买，不因为FE高而追涨，不因为过去涨幅大而机械剔除。

============================================================
DIP_REBOUND_WATCH（超跌反弹观察池 40~50分，57只）
============================================================
...
| 300985.SZ | 致远新能 | DISTRIBUTION | 49.2 | 36.25 | 结构状态DISTRIBUTION（硬风控覆盖）；硬否决：结构状态:DISTRIBUTION |
| 600784.SH | 鲁银投资 | DISTRIBUTION | 49.7 | 7.58 | 结构状态DISTRIBUTION（硬风控覆盖）；硬否决：结构状态:DISTRIBUTION |
...
| 000713.SZ | 国投丰乐 | DISTRIBUTION | 48.8 | 6.55 | 结构状态DISTRIBUTION（硬风控覆盖）；硬否决：结构状态:DISTRIBUTION |
...
- V3双评分：ENTRY=70.4 | EXPANSION=47.8 | TAIL=51.2(SAMPLE_LOW) | HVT分=0.0 | 分层=T3
- ENTRY分解：价格结构15.3 量能20.0 回踩10.0 RS8.7 板块6.3 盈亏比10.0
- EXPANSION分解：空间16.3 压缩6.5 动量8.0 RS加速3.0 量效1.0 吸收4.0 基本面3.0 催化3.0
- FE未来扩张：FE=51 FE10=54 FE20=82 FE60=70 FE120=68 | Lifecycle=MATURE TrendGain=100% Continuation=65 ExtRisk=13 Type=DISTRIBUTION_RISK
- FE分解：accel=50 base_expansion=55 continuation=65 dd20=0 dd60=0 fundamental=53 lifecycle=75 ma=85 overhead=0 platform=45 rs=44 space=41
- 分级：收盘位置=A+ 放量=D RS5=20 RS10=9 RS20=78 RS加速度=-58
- 天量日 20260814：涨幅18.3% 收盘位0.92 换手7.6% | 天量后回撤14.0% 量缩比0.43 锁筹=否
- 板块：钢铁（强度63） | 基本面：B（55） | 资金质量：35
...
- V3双评分：ENTRY=75.0 | EXPANSION=46.7 | TAIL=50.9(SAMPLE_LOW) | HVT分=0.0 | 分层=T3
- ENTRY分解：价格结构18.7 量能19.5 回踩13.5 RS7.0 板块6.3 盈亏比10.0
- EXPANSION分解：空间9.2 压缩6.0 动量6.0 RS加速3.0 量效1.0 吸收13.5 基本面3.0 催化3.0
- FE未来扩张：FE=52 FE10=57 FE20=29 FE60=71 FE120=72 | Lifecycle=EARLY TrendGain=22% Continuation=63 ExtRisk=2 Type=DISTRIBUTION_RISK
- FE分解：accel=20 base_expansion=52 continuation=63 dd20=0 dd60=0 fundamental=57 lifecycle=90 ma=85 overhead=0 platform=65 rs=23 space=29
- 分级：收盘位置=A+ 放量=D RS5=22 RS10=26 RS20=43 RS加速度=-21
- 天量日 20260810：涨幅7.9% 收盘位0.84 换手4.0% | 天量后回撤7.8% 量缩比0.46 锁筹=是
- 板块：化工（强度63） | 基本面：C（40） | 资金质量：100
- 交易计划：入场=0.00 止损=7.60 目标1=0.00 目标2=0.00 建议仓位=-
- ⛔ 硬否决：结构状态:DISTRIBUTION
- WAIT_REASON：等待突破T0_High；基本面不足；结构状态:DISTRIBUTION
...
- V3双评分：ENTRY=66.7 | EXPANSION=47.5 | TAIL=50.4(SAMPLE_LOW) | HVT分=0.0 | 分层=T3
- ENTRY分解：价格结构13.2 量能11.3 回踩11.0 RS10.6 板块6.3 盈亏比14.3
- EXPANSION分解：空间20.0 压缩6.5 动量2.0 RS加速3.0 量效1.0 吸收9.0 基本面3.0 催化3.0
- FE未来扩张：FE=44 FE10=40 FE20=99 FE60=66 FE120=68 | Lifecycle=EARLY TrendGain=45% Continuation=68 ExtRisk=16 Type=NEW_TREND
- FE分解：accel=50 base_expansion=49 continuation=68 dd20=0 dd60=0 fundamental=47 lifecycle=90 ma=65 overhead=1 platform=20 rs=68 space=20
...
### 【HVT_STRONG】桐昆股份（601233.SH）

- V3双评分：ENTRY=70.5 | EXPANSION=46.0 | TAIL=49.7(SAMPLE_LOW) | HVT分=0.0 | 分层=T3
- ENTRY分解：价格结构14.8 量能18.8 回踩11.5 RS8.8 板块6.3 盈亏比10.2
- EXPANSION分解：空间6.5 压缩8.0 动量8.0 RS加速3.0 量效1.0 吸收5.5 基本面8.0 催化3.0
- FE未来扩张：FE=61 FE10=57 FE20=98 FE60=72 FE120=76 | Lifecycle=EARLY TrendGain=42% Continuation=77 ExtRisk=9 Type=RE_ACCELERATION
- FE分解：accel=50 base_expansion=60 continuation=77 dd20=0 dd60=0 fundamental=69 lifecycle=90 ma=100 overhead=0 platform=45 rs=70 space=30
- 分级：收盘位置=A+ 放量=D RS5=14 RS10=73 RS20=86 RS加速度=-72
- 天量日 20260828：涨幅5.6% 收盘位0.85 换手3.9% | 天量后回撤5.3% 量缩比0.58 锁筹=否
- 板块：高端材料（强度63） | 基本面：A（78） | 资金质量：50
- 交易计划：入场=0.00 止损=25.52 目标1=0.00 目标2=0.00 建议仓位=5%
- WAIT_REASON：等待缩量锁筹；等待突破T0_High
- 为什么它像中际旭创：同为阶段级天量(量比2.3)、天量日价格强(涨5.6%/收盘位0.85)、相似度86.0；差异：尚未锁筹，尚未二次突破
