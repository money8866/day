"""扫描bull_stocks_qualified.csv股票池的20260611信号"""
import sys
import importlib
...
print(f'股票池: {len(pool)}只 (来源: bull_stocks_qualified.csv)')
print(f'\n开始扫描20260611信号...\n')
print('='*70)
...
for i, ts_code in enumerate(pool):
    try:
        ...
        daily_merged = daily.merge(basic[['trade_date', 'turnover_rate', 'circ_mv']], 
