...
# 读取Markdown报告
with open(r'D:\mystock\solo\multi_factor_picker\output\wave2_v2.11_report.md', 'r', encoding='utf-8') as f:
    md_content = f.read()
...
styles.add(ParagraphStyle(name='CustomTitle', fontSize=18, spaceAfter=30, alignment=TA_CENTER, textColor=colors.HexColor('#1a1a1a')))
styles.add(ParagraphStyle(name='CustomHeading1', fontSize=16, spaceAfter=12, spaceBefore=12, textColor=colors.HexColor('#2c3e50')))
styles.add(ParagraphStyle(name='CustomHeading2', fontSize=14, spaceAfter=10, spaceBefore=10, textColor=colors.HexColor('#34495e')))
styles.add(ParagraphStyle(name='CustomHeading3', fontSize=12, spaceAfter=8, spaceBefore=8, textColor=colors.HexColor('#7f8c8d')))
styles.add(ParagraphStyle(name='CustomBody', fontSize=10, spaceAfter=6, leading=14, textColor=colors.HexColor('#2c3e50')))
styles.add(ParagraphStyle(name='CustomBullet', fontSize=10, spaceAfter=4, leftIndent=20, bulletIndent=10))
