...
def build_theme_stock_map():
    ...
    theme_stock_map, name_map_basic, stock_basic_industry, stock_concepts = theme_ts.match_theme_stocks(
        hot_themes, dc_df, stock_basic_df, stock_mainbiz=stock_mainbiz, sw_data=sw_data, ths_data=ths_data
    )
    ...
    THEME_MAINBIZ_KEYWORDS = {
        ...
        '功率半导体': ['功率', 'MOSFET', 'IGBT', 'SiC', 'GaN', '碳化硅', '氮化镓', '功率器件', '功率模块', '晶闸管', '二极管', '整流桥', '高压MOS', '中低压MOS', '功率集成电路', '电源管理', '半导体分立器件', '功率半导体'],
        ...
        'PCB产业链': ['PCB', '印刷电路', '电路板', '印制电路', '覆铜板', '电子装联', '印制线路板', '高密度印制', '电子树脂', '铜箔', '玻纤布', '线路板', '电感器', '压敏电阻', '钽电容', '电子元器件', '化学试剂', '环氧树脂', '油墨', '电子材料', '专用装备', '电子级'],
    }
    ...
    THEME_INDUSTRY_EXCLUDE = {
        ...
        '功率半导体': ['化工原料', '矿物制品', '汽车配件', '汽车零部件'],
        'AI芯片': ['化工原料', '矿物制品', '汽车配件', '汽车零部件'],
        'PCB产业链': ['矿物制品', '汽车配件', '汽车零部件'],
        '软件与IT服务': ['通信设备'],
    }
    ...
    THEME_MUTEX_PAIRS = [
        ...
        ('特高压', '充电桩'),
        ('电网智能化', '充电桩'),
        # 半导体主题互斥：AI芯片/功率半导体/先进封装/PCB产业链/半导体设备/半导体制造/半导体材料 两两互斥
        # 确保一只半导体股票只归入最匹配的子主题
        ('AI芯片', '功率半导体'),
        ('AI芯片', '先进封装'),
        ('AI芯片', 'PCB产业链'),
