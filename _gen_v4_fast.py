# Generate optimized V4 half-year backtest script with reversed loop
script = '''# -*- coding: utf-8 -*-
...
with open(r'C:\Users\kongx\mystock\zhongjun_backtest_v4_nohs_fast.py', 'w', encoding='utf-8') as f:
    f.write(script)
print('Done')
